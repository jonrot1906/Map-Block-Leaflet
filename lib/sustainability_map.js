...
<i class="fa fa-info-circle" aria-hidden="true"></i>&nbsp;<span>${data_single.shortdescription}...</span>
    ...
    */
    ...
    jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/categories.json", function (data) {
    ...
    jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/regions.json", function (data) {
        jQuery.each(data, function (ind, elem) {
    ...
    jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json", function (activities_data) {
        ...
        jQuery.when.apply(jQuery, web_addresses.map(function (url) {
            ...
            jQuery.each(data, function (ind, elem) {
                ...
                if (elem.latlng == null && elem.full_address != null) {
                    promises.push(jQuery.getJSON("https://photon.komoot.io/api/?q=" + elem.full_address + "&limit=1", function (latlng_data) {
                        if (latlng_data['features'].length != 0) {
                            elem.latlng = latlng_data['features'][0]['geometry']['coordinates'];
                            [elem.latlng[0], elem.latlng[1]] = [elem.latlng[1], elem.latlng[0]];
    ...
    function getDataPoints() {
        ...
        if (jQuery("#alle-btn").is(":checked")) {
            urls.push("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=project");
            urls.push("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=store");
            urls.push("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=education");
            urls.push("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=counseling");
            urls.push("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=event&upcoming");
        }
        ...
        if (!(jQuery.trim(jQuery("#startDate").val()) == "") && !(jQuery.trim(jQuery("#endDate").val()) == "")) {
            ...
            jQuery.each(listDate, function (key, value) {
                var url_date = "https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=event&timestamp=" + value;
    ...
    jQuery(document).on("click", ".modal_link", function (e) {
        ...
        jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/users/" + obj.user_id + ".json", function (organisation_data) {
        ...
        if (obj.latlng == null && obj.full_address != null) {
            jQuery.getJSON("https://photon.komoot.io/api/?q=" + obj.full_address + "&limit=1", function (obj_latlng_data) {
                if (obj_latlng_data['features'].length != 0) {
                    obj.latlng = obj_latlng_data['features'][0]['geometry']['coordinates'];
                    [obj.latlng[0], obj.latlng[1]] = [obj.latlng[1], obj.latlng[0]];
                    switch (obj.service_type) {
                        case "Projekt":
                        case "Filiale":
    ...
    jQuery(document).on("click", ".organisation_link", function (e) {
        ...
        jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/users/" + org_id + ".json", function (organisation_data) {
            ...
            if (organisation_data.latlng == null) {
                jQuery.getJSON("https://photon.komoot.io/api/?q=" + organisation_data.full_address + "&limit=1", function (organisation_latlng_data) {
                    if (organisation_latlng_data['features'].length != 0) {
                        organisation_data.latlng = organisation_latlng_data['features'][0]['geometry']['coordinates'];
                        [organisation_data.latlng[0], organisation_data.latlng[1]] = [organisation_data.latlng[1], organisation_data.latlng[0]];
