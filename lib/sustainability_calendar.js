...
document.addEventListener("DOMContentLoaded", function () {
    ...
    jQuery("#calendarButton").click(function (event) {
        ...
        jQuery.getJSON("https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/users/" + obj_cal_btn.user_id + ".json", function (organisation_data) {
            ...
            icsMSG += "BEGIN:VEVENT\r\n";
            icsMSG += "UID:admin@rotter-webdesign.de\r\n"
    ...
    var center = [51.340199, 12.360103];
    ...
    function getDataPoints() {
        let urls = [
            "https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=education",
            "https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=counseling",
            "https://cors-anywhere-528p.onrender.com/https://daten.nachhaltiges-sachsen.de/api/v1/activities.json?type=event&upcoming",
        ]
        var region_arr = [],
        category_arr = [];
